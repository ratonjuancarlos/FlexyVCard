                                    ...
                                    <div className="col-md-12" style={{width: '100%', WebkitBoxSizing: 'border-box', boxSizing: 'border-box', float: 'left', background: 'rgba(255, 255, 255, 0.8)', paddingBottom: '15px', paddingTop: '15px'}}>
                                        ...
                                        <article className="postPage">
                                            ...
                                            <div className="title_content">
                                                <div className="text_content">BLOG ASIDE POST</div>
                                            ...
                                            <div className="col-md-12 first">
                                                ...
                                                <div className="col-md-12"  style={{marginTop: '20px'}}>
                                                    <a href="#post-3" className="readmore" id="pagination"><i className="glyphicon glyphicon-chevron-right"></i></a>
                                                    <a href="#post-1" className="readmore" id="pagination"><i className="glyphicon glyphicon-chevron-left"></i></a>
